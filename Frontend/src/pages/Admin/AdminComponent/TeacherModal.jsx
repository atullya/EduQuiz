...
import { Plus, Mail, Phone, CalendarIcon, AlertCircle, Loader2, Eye, EyeOff, UserPlus } from "lucide-react"
import { apiService } from "../../../services/apiServices"

const TeacherModal = ({ open, onOpenChange, onStudentAdded }) => {
  ...
  const getSectionsForGrade = (selectedGrade) => {
    ...
    const sectionsForGrade = classes.filter((cls) => cls.grade === selectedGrade).map((cls) => cls.section)
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!res || !res.success) {
        throw new Error(res.message || "Failed to create teacher user")
      }

      console.log("Teacher user created successfully:", res.data)
      setSuccess(true)
      ...
      <DialogContent className="w-full max-w-5xl !max-w-5xl !w-full max-h-[95vh] overflow-y-auto bg-gradient-to-br from-blue-50 to-purple-50">
        ...
        {success && (
          <Alert className="border-green-200 bg-green-50 mb-4">
            ...
            <AlertDescription className="text-green-800">Teacher account created successfully!</AlertDescription>
          </Alert>
        )}
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <div className="flex gap-2 mt-1">
                  ...
                  <Button
                    ...
                    disabled={isSubmitting || !formData.profile.firstName || !formData.profile.lastName}
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <Label className="text-sm font-medium text-gray-700">Assigned Section *</Label>
                <Select
                  value={formData.profile.section}
                  onValueChange={(v) => handleSelectChange("profile.section", v)}
                  disabled={isSubmitting || !formData.profile.class}
                >
                  <SelectTrigger className="mt-1">
                    <SelectValue placeholder={formData.profile.class ? "Select section" : "Select class first"} />
                  </SelectTrigger>
                  <SelectContent>
