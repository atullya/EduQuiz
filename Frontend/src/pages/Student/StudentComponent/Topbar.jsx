            ...
            <div className="absolute right-0 top-full mt-2 w-96 bg-white shadow-2xl rounded-xl border border-gray-100 z-50 overflow-hidden">
              ...
              {notifications.length > 0 && (
                <div className="px-5 py-3 bg-gray-50/50 border-t border-gray-100">
                  <button className="w-full text-center text-sm font-medium text-blue-600 hover:text-blue-700 py-2 hover:bg-blue-50 rounded-lg transition-colors duration-200">
